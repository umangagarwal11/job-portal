...
<div class="col-6 d-flex flex-column justify-content-center align-items-center" style="width:200% !important; margin-top:-7%;">
  ...
  <div class="toasta" role="alert" aria-live="assertive" aria-atomic="true" style="background-color:#;transition:opacity 1s ease;" data-delay="5000" id="qwe">
    <div class="toast-header" style="width:100%;background-color:#ab0505; opacity:1; color:white;" >
      Community member successfully deleted.
...
$start = ($page - 1) * $limit;
$s = "SELECT * FROM applications order by time desc LIMIT $start, $limit";
$aresult = mysqli_query($con,$s);

$ap = "SELECT * FROM applications order by time desc";
  ...
  <div class="collapse navbar-collapse justify-content-center"  id="navbarNavDropdown">
    <ul class="navbar-nav justify-content-center" style="width:100%;" >
        <li class="nav-item " style="margin-right:10%;">
         <button type="button" class="btn " data-toggle="modal" data-target="#notification" style="background:rgb(0,0,0,0); color:white; text-align:left;">
              Send Notification
            </button>
      </li>
      <li class="nav-item " style="margin-right:10%">
      ...
      <?php
	  if($_SESSION['username']=="cbi_admin")
	  {
		echo'<li class="nav-item " style="margin-left:10%;">
         <button type="button" class="btn " data-toggle="modal" data-target="#addadmin" style="background:rgb(0,0,0,0); color:white;">
		Add Admin
</button>
      </li>';
	  }
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background:#38b0de;">
        <h5 class="modal-title" id="exampleModalLabel" style="color:white;">Add Admin</h5>
      ...
      <div class="modal-body">
        <form action="" method = "post">
			<div class="form-group">
				<input type = "text" name = "admin" class  = "form-control" multiple required placeholder ="Username" style="border:2% !important; border-style:solid"></div>
				
			<div class="form-group">
				<input type = "password" name = "adp" id="apass" class  = "form-control" required placeholder ="Password" style="border:2% !important; border-style:solid"></div>
				
			<div class="form-group">
				<input type = "password" name = "adp1" id="acpass" class  = "form-control" required placeholder ="Confirm Password" style="border:2% !important; border-style:solid"></div>
				
			<div class="ml-auto mr-auto" align="right"><button type = "submit" class = "btn btn-primary" id="add" style="background:#29AB87;" disabled>  Submit</button>  </div>
		  </form>
				...
				$cate=$_POST['admin'];
				$a=md5($_POST['adp1']);
				$result=mysqli_query($con,"insert into `admintable` values('$cate','$a',now())");
				if($result)
					$_SESSION['f']=120;
				else
					$_SESSION['f']=121;
...
<!-- Modal -->
<div class="modal fade " id="notification" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel3" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background:#38b0de;">
        <h5 class="modal-title" id="exampleModalLabel" style="color:white;">Send a Notification</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="color:white;">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form action="" method = "post">
			<div class="form-group">
				<input type = "email" name = "reciever" class  = "form-control" multiple required placeholder ="Recipient" style="border:2% !important; border-style:solid"></div>
				
			<div class="form-group">
				<input type = "text" name = "sub" class  = "form-control" required placeholder ="Subject" style="border:2% !important; border-style:solid"></div>	
				
			<div class="form-group">
				<textarea type = "text" name = "msg" class  = "form-control" multiple required placeholder ="Message" style="border:2% !important; border-style:solid"></textarea></div>
		  ...
		  <?php
				...
				$msg=$_POST['msg'];
				$msg = wordwrap($msg, 70);
				$headers = "From: CodeBinary Opportunities<opportunity@codebinary.in>" . "\r\n" .
				"BCC: nilayjayswalnj@gmail.com"."\r\n"."Reply-To: CodeBinary Opportunities<opportunity@codebinary.in>";
				$check=mail($r,$sub,$msg,$headers);
				if($check== false)
					$_SESSION['f']=201;
				else
					$_SESSION['f']=200;
...
<div class="container" style="margin-top:2.5%;">
    <div class="row">
        ...
        <ul class="pagination">
          <li class = "page-item">
            <a class = "page-link" href="app.php?page=<?= $Previous; ?>" aria-label="Previous">
              <span aria-hidden="true">&laquo; </span>
            </a>
          </li>
          <?php for($i = 1; $i<= $pages; $i++) : 
			if($i!=$page)
				echo '<li class = "page-item "><a class = "page-link" href="app.php?page='.$i.'">'.$i.'</a></li>';
			else 
				echo '<li class = "page-item active"><a class = "page-link" href="app.php?page='.$i.'">'.$i.'</a></li>';
		   endfor; ?>
          <li class = "page-item">
            <a class = "page-link" href="app.php?page=<?= $Next; ?>" aria-label="Next">
            ...
            <table class="table" style="width:100%;">
                <thead>
                    <tr class="filters" style="background:#29ab87;">
                        ...
                        <th><input type="text" style="background:rgb(0,0,0,0); color:white;" class="form-control booty" placeholder="Applied by" disabled></th>
				...
				$fname=mysqli_fetch_row(mysqli_query($con,"Select * from usertable where href='$row[0]'"));
                        if($row[2]=="Hired"){
                    echo'<tr>
                        <td></td>
                        <td>
                            <a style="color:#38b0de;text-decoration:none;" target="_blank" href="jobman.php?job='.$row[1].'">'.$row[1].'</a>
                        </td>
                        <td><a style="color:#38b0de;text-decoration:none;" target="_blank" title="View Profile" href="./profile.php?user='.$row[0].'">'.$fname[0].' '.$fname[1].'</a></td>';
                        
                        if(!file_exists("./offerletters/".$row[4].".pdf")){
                        echo '<td>
                        <form method="post">
			<div class="form-group col-12">
				<select class="form-control" name="status" onchange="this.form.submit()" required>';
					
					$result = mysqli_query($con, "select * from statuses");
						while($rows=mysqli_fetch_row($result))
						{
						    if($rows[0]==$row[2])
							echo '<option multiple style="color:#'.$rows[1].'" value="'.$rows[0].':'.$row[4].'" selected>'.$rows[0].'</option>';
							else
							
							echo '<option multiple style="color:#'.$rows[1].'" value="'.$rows[0].':'.$row[4].'" >'.$rows[0].'</option>';
						}
                        echo'</select>
			</div>
			</form></td>
                        <td>'.$row[3].'</td>
						<td>
                        <button class="col btn btn-success"  data-toggle="modal" data-target="#exampleModal'.$row[4].'">Generate Offer Letter
                        </button>
						</td><td></td>
                    </tr>
                    
                    <!-- Modal -->
<div class="modal fade " id="exampleModal'.$row[4].'" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background:#38b0de;">
        <h5 class="modal-title" id="exampleModalLabel" style="color:white;">Generate Offer Letter</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="color:white;">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form action="pdfgen.php" method = "post">
			...
			<div class="form-group">
				<textarea type = "text" name = "cadd" class  = "form-control" multiple required placeholder ="Intern\'s communication address" style="border:2% !important; border-style:solid"></textarea></div>
        
            <div class="form-group"><input type = "number" name = "dur" class  = "form-control" min=1 required placeholder ="Duration (in months)" style="border:2% !important; border-style:solid" ></div>
            
            <div class="form-group form-inline">
            <label for="join"  class="col-4" style="display:block; text-align:left; padding:0;">Date of Joining:</label>
            <input style="border:2% !important; border-style:solid" type="date" id="join" class="form-control col-8" name="join">
		    </div>
		    
			<div class="form-group">
				<input type = "text" name = "day" class  = "form-control" multiple required placeholder ="Day of Joining" style="border:2% !important; border-style:solid"></div>
			
			<div class="form-group form-inline">	
            <label for="resp" class="col-4" style="display:block; text-align:left; padding:0;">Date of Response:</label>
            <input type="date" id="resp" class="col-8 form-control" style="border:2% !important; border-style:solid" name="resp">
			</div>
				
			<div class="ml-auto mr-auto" align="right"><button type = "submit" class = "btn btn-primary" style="background:#29AB87;" name="appid" value='.$row[4].' >  Submit</button>  </div>
		  </form>
      </div>
    </div>
  </div>
                        ...
                        echo '<td style="color: #29AB87; padding-left:4%; font-size:120%">Hired</td>
                        <td>'.$row[3].'</td>
						<td>
                        <a href="./offerletters/'.$row[4].'.pdf" class="btn btn-success" style="background:#38b0de;" download="'.$row[0].'_offerletter_for_'.$row[1].'.pdf">View Offer Letter</a>
                        </td>';
						if ($row[6]==0){
							echo'<td><form method="post">
							<button value='.$row[4].' type="submit" class="btn" style="background-color:#ab0505; color:white;" name="khatam">End Internship</button>
							</form></td>';
						}
						else{
						if(!file_exists("./LOR/".$row[4].".pdf")){
						echo'<td>
                        <button class="col btn btn-success"  data-toggle="modal" data-target="#exampleModalLOR'.$row[4].'">Generate LOR
                        </button>
						</td>';}
						else{
						echo'<td>
                        <a href="./LOR/'.$row[4].'.pdf" class="btn btn-success" style="background:#38b0de;" download="'.$row[0].'_LOR_for_'.$row[1].'.pdf">View LOR</a>
                        </td>';
						}
						}
						echo '</tr>
                    ...
                    <!-- Modal -->
<div class="modal fade " id="exampleModalLOR'.$row[4].'" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background:#38b0de;">
        <h5 class="modal-title" id="exampleModalLabel" style="color:white;">Generate LOR</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="color:white;">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form action="LORgen.php" method = "post">
        
			<div class="form-group">
				<textarea type = "text" name = "content" rows=15 class  = "form-control" multiple required placeholder ="Content of LOR" style="border:2% !important; border-style:solid"></textarea></div>
				...
				<div class="ml-auto mr-auto" align="right"><button type = "submit" class = "btn btn-primary" style="background:#29AB87;" name="appid" value='.$row[4].' >  Submit</button>  </div>
						...
						if (isset($_POST['khatam'])){
							$fin=date("Y-m-d");
							$res=mysqli_query($con,"Update applications set end=1,fin=\"$fin\" where id=".$_POST['khatam']);
							$_SESSION['f']=91;
							echo "<meta http-equiv=\"refresh\" content=\"0\" />";
						}
                        }
                    else if ($row[2]=="Shortlisted" && $row[5]==1){
                    echo'<tr>
                        <td></td>
                        <td>
                            <a style="color:#38b0de;text-decoration:none;" target="_blank" href="jobman.php?job='.$row[1].'">'.$row[1].'</a>
			...
			<div class="form-group col-12">
				<select class="form-control" name="status" onchange="this.form.submit()" required>';
					...
					$result = mysqli_query($con, "select * from statuses");
                        ...
                        <td>'.$row[3].'</td>
                        <td><span style="color:#800080">Appeared for Personality Test</span></td><td></td>
                    </tr>';}
                    else{
                    echo'<tr>
                        <td></td>
			...
			<div class="form-group col-12">
                ...
                function cdelete($user)
			{
				include('db.php'); 
				$result=mysqli_query($con,"delete from cCommunity WHERE id='$user'");
				$_SESSION['f']=20;
...
if (isset($_POST['status'])) {
				$ab=explode(":",$_POST['status']);
				$id=$ab[1];
				$val=$ab[0];
				$res=mysqli_query($con,"Update applications set status=\"$val\" where id=$id");
				if($val=="Hired"){
				$jid=mysqli_fetch_row(mysqli_query($con,"Select job from applications where id=$id"))[0];
				$no=mysqli_fetch_row(mysqli_query($con,"Select count from jobs where id='$jid'"))[0]-1;
				$res=mysqli_query($con,"Update jobs set count=$no where id='$jid'");}
				$_SESSION['f']=22;
				echo "<meta http-equiv='refresh' content='0'/>"; 
...
$('#apass, #acpass').bind('keyup', function() {
    if($("#apass").val() == $("#acpass").val())
