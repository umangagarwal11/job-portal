...
$start = ($page - 1) * $limit;
$s = "SELECT * FROM cCommunity order by fname LIMIT $start, $limit";
$aresult = mysqli_query($con,$s);

$ap = "select * from cCommunity";
...
$search=array();
$online=array();
$aayega=mysqli_query($con,"select href,online from usertable");
      ...
      <li class="nav-item " style="margin-right:10%">
        <div class="dropdown" >
          ...
          <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
            <button type="button" class="btn " data-toggle="modal" data-target="#exampleModal1" style="background:rgb(0,0,0,0); color:black; text-align:left;">
                Add
            </button>
            
            <button type="button" class="btn col-12" data-toggle="modal" data-target="#exampleModal2" style="background:rgb(0,0,0,0); color:black; text-align:left;">
              Import
            </button>
...
<div class="container" style="margin-top:2.5%;">
    ...
    <div class="row">
        ...
        <ul class="pagination">
          <li class = "page-item">
            <a class = "page-link" href="dash.php?page=<?= $Previous; ?>" aria-label="Previous">
              <span aria-hidden="true">&laquo; </span>
            </a>
          </li>
          <?php for($i = 1; $i<= $pages; $i++) : 
			if($i!=$page)
				echo '<li class = "page-item "><a class = "page-link" href="dash.php?page='.$i.'">'.$i.'</a></li>';
			else 
				echo '<li class = "page-item active"><a class = "page-link" href="dash.php?page='.$i.'">'.$i.'</a></li>';
		   endfor; ?>
          <li class = "page-item">
            <a class = "page-link" href="dash.php?page=<?= $Next; ?>" aria-label="Next">
            ...
            <div class="panel-heading">
                <div class="pull-right">
                    <button type="button" class="btn mr-1 " data-toggle="modal" data-target="#exampleModal17" style="background:#29ab87; color:white;">
                 Add 
            </button>
            ...
            <table class="table" style="width:100%;">
                <thead>
                    <tr class="filters" style="background:#29ab87;">
                        ...
                        <th><input type="text" style="background:rgb(0,0,0,0); color:white;" class="form-control booty" placeholder="Full Name" disabled></th>
                        <th><input type="text"  style="background:rgb(0,0,0,0); color:white;" class="form-control booty" placeholder="Position" disabled></th>
                        <th><input type="text" style="background:rgb(0,0,0,0); color:white;" class="form-control booty" placeholder="Division" disabled></th>
                        <th><input type="text" style="background:rgb(0,0,0,0); color:white;" class="form-control booty" placeholder="Institution" disabled></th>
                ...
                while($row=mysqli_fetch_row($aresult)){
                    ...
                    echo'<tr>
                        ...
                        <td>'.$row[5].'</td>
                        <td>'.$row[6].'</td>
                        <td><a href="mailto:'.$row[8].'" style="margin-top:-2%; font-size:170%" class="ace ace1" target="_blank"><i class="fa fa-at icon"></i></a></td>
                        <td><form method="post" class="form-inline" style="text-align:left;padding-bottom:0; margin-bottom:0;">
							<button name="cdelete" class="col btn btn-danger" value="'.$row[0].'">Delete</button>
								</form></td>
                    </tr>';
                    $x=$x+1;}
                        ...
                        if($online[$row[7]]==1)
                    echo'<tr>
                        <td ><span style="color:#29ab87; font-size:200%;">•</span></td>
                        <td><a style="color:#38b0de;text-decoration:none;" target="_blank" title="View Profile" href="./profile.php?user='.$row[7].'">'.$row[7].'</a></td>
                        <td>'.$row[1].' '.$row[2].'</td>
                        <td>'.$row[3].' '.$row[4].'</td>
                        <td>'.$row[5].'</td>
                        <td>'.$row[6].'</td>
                    ...
                    echo'<tr>
                        <td><span style="color:#ab0505; font-size:200%;">•</span></td>
                        <td><a style="color:#38b0de;text-decoration:none;" target="_blank" title="View Profile" href="./profile.php?user='.$row[7].'">'.$row[7].'</a></td>
                        <td>'.$row[1].' '.$row[2].'</td>
                        <td>'.$row[3].' '.$row[4].'</td>
                        <td>'.$row[5].'</td>
...
<!-- Modal -->
<div class="modal fade" id="exampleModal17" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel3" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background:#38b0de;">
        <h5 class="modal-title" id="exampleModalLabel" style="color:white;">Add a Community member</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="color:white;">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form method="post">
            ...
            <div class="form-group">
				<input type = "text" name = "cname" class = "form-control" multiple required placeholder ="Full Name" style="border:2% !important; border-style:solid">
			</div>
            
            
            <div class="form-group">
				<input type = "text" name = "cpos" class  = "form-control" multiple required placeholder ="Position" style="border:2% !important; border-style:solid"></div>
				
            <div class="form-group">
				<input type = "text" name = "cdom" class  = "form-control" multiple required placeholder ="Domain" style="border:2% !important; border-style:solid"></div>
            
            <div class="form-group">
				<input type = "text" name = "cdiv" class  = "form-control" multiple required placeholder ="Division" style="border:2% !important; border-style:solid"></div>
			
            <div class="form-group">
				<input type = "text" name = "cins" class  = "form-control" multiple required placeholder ="Institution" style="border:2% !important; border-style:solid"></div>
				
            <div class="form-group">
				<input type = "text" name = "chref" class  = "form-control" multiple placeholder ="Href" style="border:2% !important; border-style:solid">
			</div>
			
			
            <div class="form-group">
				<input type = "email" name = "cmail" class  = "form-control" multiple required placeholder ="E-mail" style="border:2% !important; border-style:solid">
			</div>
			
			<div class="form-group">
				<select class="form-control" name="lev" required>
			...
			<div class="ml-auto mr-auto" align="right"><button type = "submit" class = "btn btn-primary" id="ur" style="background:#29AB87;">  Submit</button>  </div>
			<?php
				...
				$lev=$_POST['lev'];
				$mail=$_POST['cmail'];
				$name1=explode(" ",$_POST['cname'])[0];
				$name2=substr(strstr($_POST['cname']," "), 1);
				$result=mysqli_query($con,"insert into `cCommunity`(fname,lname,position,domain,division,institution,reference_code,email,level) values(\"$name1\",\"$name2\",\"$pos\",\"$dom\",\"$div\",\"$ins\",'$href','$mail','$lev')");
				$_SESSION['f']=21;
...
$('#pos, #domain, #dep, #org, #exp,#duration,#des, #cou,#sti').bind('keyup', function() {
