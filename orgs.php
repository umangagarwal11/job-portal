...
$start = ($page - 1) * $limit;
$s = "SELECT * FROM organizations order by name LIMIT $start, $limit";
$aresult = mysqli_query($con,$s);

$ap = "select * from organizations";
...
<div class="container" style="margin-top:2.5%;">
    <div class="row">
        ...
        <ul class="pagination">
          <li class = "page-item">
            <a class = "page-link" href="orgs.php?page=<?= $Previous; ?>" aria-label="Previous">
              <span aria-hidden="true">&laquo; </span>
            </a>
          </li>
          <?php for($i = 1; $i<= $pages; $i++) : 
			if($i!=$page)
				echo '<li class = "page-item "><a class = "page-link" href="orgs.php?page='.$i.'">'.$i.'</a></li>';
			else 
				echo '<li class = "page-item active"><a class = "page-link" href="orgs.php?page='.$i.'">'.$i.'</a></li>';
		   endfor; ?>
          <li class = "page-item">
            <a class = "page-link" href="orgs.php?page=<?= $Next; ?>" aria-label="Next">
            ...
            <table class="table" style="width:100%;">
                <thead>
                    <tr class="filters" style="background:#29ab87;">
                        ...
                        <th><input type="text" style="background:rgb(0,0,0,0); color:white;" class="form-control booty" placeholder="Description" disabled></th>
                        <th><input type="text" style="background:rgb(0,0,0,0); color:white;" class="form-control booty" placeholder="Rep Name" disabled></th>
                ...
                while($row=mysqli_fetch_row($aresult)){
                    echo'<tr>
                        <td>'.($start+$x).'</td>
                        <td><a style="color:#38b0de;text-decoration:none;" target="_blank" href="'.$row[2].'">'.$row[0].'</a></td>
                        <td>'.$row[1].'</td>
                        <td>'.$row[3].'</td>
                        <td><a href="mailto:'.$row[4].'" style="margin-top:-2%; font-size:170%" class="ace ace1" target="_blank"><i class="fa fa-at icon"></i></a></td>
                    </tr>';
                    $x=$x+1;
                }
                ?>
